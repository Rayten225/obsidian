...
- [ ] [BUG:: Информатика | №24] Ошибка в регулярном выражении `([6789][67890]+)([-+](0|[6789][67890]+))+` вместо + на до * (`[67890]+`)  -> так как может быть 123+2+34 если сделать + то будут только от двухзначных чисел а если * то цифры тоже будут работать   🗓️2026-07-09
